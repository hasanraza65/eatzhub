                    ...
                    <div class="card-body">
                        <form  id="{{ getFormId() }}" method="post" action="{{ route('newrestaurant.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
								...
								<input type="checkbox" id="pp" value="pp_checkbox" required /> <label  class="form-control-label"> <a href="/pages/1" target="_blank class="nav-link">Terms and conditions</a></label>
                                </div>
